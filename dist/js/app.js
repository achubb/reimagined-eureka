...
Vue.component('gallery', __webpack_require__(13));
...
Component.options.__file = "/Users/andrewchubb/Scratch/gallery/src/js/components/Gallery.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-800f4b8e", Component.options)
  } else {
    hotAPI.reload("data-v-800f4b8e", Component.options)
  }
...
var Masonry = __webpack_require__(35);
var baguetteBox = __webpack_require__(40);
var _imagesLoaded = __webpack_require__(41);
var scrollMonitor = __webpack_require__(48);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadImages: function loadImages() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.requestURL).then(function (response) {
                _this.galleryImages = response.data;
            }).catch(function (e) {
                _this.galleryErrors.push(e);
            });
        },

        scrollWatch: function scrollWatch() {
            var grid = document.querySelector('.gallery__loading');
            var elementWatcher = scrollMonitor.create(grid);
        ...
        loadNextImages: function loadNextImages() {
            var _this2 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.requestURL).then(function (response) {
                ...
                if (responseData.length != 0) {
                    for (var i = 0; i < responseData.length; i++) {
                        _this2.galleryImages.push(responseData[i]);
                    }
                } else {
                    _this2.loadingMessage = "End Of Gallery";
                    _this2.endOfGallery = true;
                }
            }).catch(function (e) {
                _this2.galleryErrors.push(e);
            });
        },
            ...
            this.$nextTick(function () {
                setTimeout(function () {
                    ...
                    function onProgress(imgLoad, image) {
                        ...
                        var imageEl = image.img.parentNode;
                    ...
                    var imgLoadStatus = _imagesLoaded(images);
        ...
        setupFilters: function setupFilters() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.categoryFeed).then(function (response) {
                var responseData = response.data;
                if (responseData.length != 0) {
                    for (var i = 0; i < responseData.length; i++) {
                        var obj = {
                        ...
                        _this3.galleryFilters.push(obj);
                    }
                }
            }).catch(function (e) {
                _this3.galleryFilterErrors.push(e);
            });
        },
        ...
        filter: _.debounce(function (cat) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.imageFeed + '?_page=' + this.galleryPage + '&_limit=' + this.galleryPageLim + '&category=' + cat).then(function (response) {
                _this4.galleryImages = response.data;
            }).catch(function (e) {
                _this4.galleryErrors.push(e);
            });
            // set active filter
        ...
        setActiveFilter: function setActiveFilter(cat) {
            for (var i = 0; i < this.galleryFilters.length; i++) {
                var filter = this.galleryFilters[i].filterName;
                if (cat === filter) {
        ...
        lightBoxDestroy: function lightBoxDestroy() {
            this.$nextTick(function () {
                setTimeout(function () {
                    baguetteBox.destroy();
                }, 50);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "gall"
  }, [_c('h2', [_vm._v(_vm._s(_vm.message))]), _vm._v(" "), (_vm.galleryFilters && _vm.galleryFilters.length) ? _c('ul', {
    staticClass: "gallery__filter"
  }, [_c('li', {
    staticClass: "gallery__filter__button"
  }, [_c('a', {
    attrs: {
      "href": "#"
    },
  ...
  }, [_vm._v("\n                    Show All\n            ")])]), _vm._v(" "), _vm._l((_vm.galleryFilters), function(galleryFilter) {
    return _c('li', {
      staticClass: "gallery__filter__button"
    }, [_c('a', {
      class: {
        'filter-active': galleryFilter.active
      },
      attrs: {
        "href": "#"
      },
      on: {
        "click": function($event) {
          $event.preventDefault();
          _vm.filter(galleryFilter.filterName)
        }
      }
    }, [_vm._v("\n                    " + _vm._s(galleryFilter.filterName) + " |\n                    " + _vm._s(galleryFilter.active) + "\n            ")])])
  })], 2) : _vm._e(), _vm._v(" "), (_vm.galleryImages && _vm.galleryImages.length) ? _c('div', {
    staticClass: "gallery"
  }, [_vm._l((_vm.galleryImages), function(galleryImage) {
    return _c('a', {
    ...
    staticClass: "gallery__sizer"
  }), _vm._v(" "), _c('div', {
    staticClass: "gallery__gutter-sizer"
  })], 2) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "gallery__loading",
    class: {
      'gallery__loading--loaded': _vm.endOfGallery
    }
  }, [(_vm.endOfGallery) ? _c('span', [_vm._v(_vm._s(_vm.loadingMessage))]) : _c('img', {
    attrs: {
      "src": "/img/640/gear.gif",
      "alt": ""
    }
  })]), _vm._v(" "), (_vm.galleryErrors && _vm.galleryErrors.length) ? _c('ul', _vm._l((_vm.galleryErrors), function(galleryError) {
    return _c('li', [_c('p', [_vm._v(_vm._s(galleryError.message))])])
  })) : _vm._e()])
},staticRenderFns: []}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-800f4b8e", module.exports)
  }
}
